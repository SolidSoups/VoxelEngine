...
std::unique_ptr<TextureViewer>       EditorLayer::myTextureViewer  = nullptr;
...
void EditorLayer::Initialize(GLFWwindow *aWindow)
{
    ...
    myTextureViewer  = std::make_unique<TextureViewer>();
}
...
{
    EditorLayer::myEditors.push_back(std::make_unique<PhysicsEditor>(aPhysicsRuntime));
}
