...
class Scene
{
  public:
    ...
    // move
    Scene(Scene &&other) noexcept : myVoxelChunk(std::move(other.myVoxelChunk)) {}
    ...
    void               Render();
    void               Update();
    inline VoxelChunk &GetVoxelChunk()
    {
        return myVoxelChunk;
    }
    inline const VoxelChunkViews &GetChunkViews() const
    {
        return myChunkViews;
    }
    ...
    inline Mesh &GetVoxelMesh()
    {
        return myChunkMesh;
    }
    inline MeshStats GetStats() const
    {
